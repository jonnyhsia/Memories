...
class TextTabLayout @JvmOverloads constructor(
    ...
    init {
        ...
        _tabSelectedSize = context.px2sp(typedArray.getDimensionPixelSize(R.styleable.TextTabLayout_x_tabTextSelectedSize, 32).toFloat())
        _tabTextSize = context.px2sp(typedArray.getDimensionPixelSize(R.styleable.TextTabLayout_x_tabTextSize, 24).toFloat())
        _tabTextColor = typedArray.getColor(R.styleable.TextTabLayout_x_tabTextColor, Color.BLACK)
        _textTextSelectedColor = typedArray.getColor(R.styleable.TextTabLayout_x_tabTextSelectedColor, Color.BLACK)

        // 通过 spacing 设置 layout divider
        val tabSpacing = typedArray.getDimension(R.styleable.TextTabLayout_x_tabSpacing, context.dp2px(20f))
    ...
    private fun Context.px2sp(pxValue: Float): Float =
