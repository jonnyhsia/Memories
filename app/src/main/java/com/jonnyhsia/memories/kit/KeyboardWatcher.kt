package com.jonnyhsia.memories.kit
...
class KeyboardWatcher(activity: FragmentActivity) : LifecycleObserver {
    ...
    abstract class SimpleKeyboardToggleListener : OnKeyboardToggleListener {
        final override fun onKeyboardShown(keyboardSize: Int) {
            onKeyboardVisibilityChanged(true)
        }

        final override fun onKeyboardClosed() {
            onKeyboardVisibilityChanged(false)
        }

        abstract fun onKeyboardVisibilityChanged(isVisible: Boolean)
    }
}